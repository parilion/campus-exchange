...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .and()
            .authorizeRequests()
                .antMatchers("/api/auth/register", "/api/auth/login", "/api/auth/test",
                ...
                .antMatchers(HttpMethod.GET, "/api/users/browse-history").authenticated()
                .antMatchers(HttpMethod.DELETE, "/api/users/browse-history/**").authenticated()
                .antMatchers(HttpMethod.PUT, "/api/users/profile").authenticated()
                .antMatchers(HttpMethod.POST, "/api/users/avatar").authenticated()
